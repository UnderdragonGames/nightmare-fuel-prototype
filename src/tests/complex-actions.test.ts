...
const G: GState = {
	...
	secret: { deck: [] },
	discard: [],
	players: buildPlayers({ '0': [makeCard(['O']), makeCard(['B']), makeCard(['Y']), makeCard(['G']), makeCard(['R']), makeCard(['V'])] }, { prefs: { primary: 'R', secondary: 'O', tertiary: 'V' } }),
	treasure: [],
	stats: { placements: 0 },
